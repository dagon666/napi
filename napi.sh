...
# libraries
. "${G_NAPISHAREPATH}/libs/libnapi_argv.sh"
. "${G_NAPISHAREPATH}/libs/libnapi_assoc.sh"
. "${G_NAPISHAREPATH}/libs/libnapi_constants.sh"
. "${G_NAPISHAREPATH}/libs/libnapi_fs.sh"
. "${G_NAPISHAREPATH}/libs/libnapi_http.sh"
. "${G_NAPISHAREPATH}/libs/libnapi_language.sh"
...
. "${G_NAPISHAREPATH}/libs/libnapi_xml.sh"
...
_executeAction() {
    ...
    source "${G_NAPISHAREPATH}/actions/libnapi_${action}.sh"
